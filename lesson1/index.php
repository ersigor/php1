...
<head>
	...
	<title><?php $title ="Заголовок"  ?></title>
</head>
<body>
	<div id="content">
		...
		<div id="footer">
		      <p>Copyright &copy; <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a> <?php echo "сделано в 20".date (y)." году" ?></p>
		</div>	
	</div>
</body>
</html>